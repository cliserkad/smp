...
public class PathMap<V> extends HashMap<Path, V> {
	...
	/**
	 * Retrieves the V related to specified Path. Returns null if no V is related.
	...
	/**
	 * Converts a list of Strings in to a Path, then retrieves the V related to that
	 * Path. Returns null if no V is related.
	 *
	...
	/**
	 * Retrieves the V related to specified Path. Returns defaultValue if no V is
	 * related. Will auto-cast String to Path.
	 *
	 * @param key          String or Path
